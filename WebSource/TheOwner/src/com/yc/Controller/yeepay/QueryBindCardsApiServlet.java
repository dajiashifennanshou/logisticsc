...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-03 23:36
 */

public class QueryBindCardsApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QueryBindCardsApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//第六步 hmac签名验证
		if(!ZGTUtils.checkHmac(responseDataMap, ZGTUtils.QUERYBINDCARDSAPI_RESPONSE_HMAC_ORDER)) {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/419queryBindCardsApiResponse.jsp");
