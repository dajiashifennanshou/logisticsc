...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-03 17:27
 */

public class QueryDivideApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QueryDivideApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/411queryDivideApiResponse.jsp");
