...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-03 22:41
 */

public class QueryCashTransferApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QueryCashTransferApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/417queryCashTransferApiResponse.jsp");
