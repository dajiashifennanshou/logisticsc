...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-03 21:15
 */

public class QueryBalanceApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QueryBalanceApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//第六步 hmac签名验证
		if(!ZGTUtils.checkHmac(responseDataMap, ZGTUtils.QUERYBALANCEAPI_RESPONSE_HMAC_ORDER)) {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/415queryBalanceApiResponse.jsp");
