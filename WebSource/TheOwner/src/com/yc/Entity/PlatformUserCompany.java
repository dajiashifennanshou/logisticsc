...
public class PlatformUserCompany implements Serializable {
	...
	private List<TmsLineInfo> list;
	
	private List<PlatformDeliverGoods> pdglist;
	...
	public List<PlatformDeliverGoods> getPdglist() {
		return pdglist;
	}
	public void setPdglist(List<PlatformDeliverGoods> pdglist) {
	...
	public String getContacts1_mobile() {
		return contacts1_mobile;
	}
	public void setContacts1_mobile(String contacts1_mobile) {
		this.contacts1_mobile = contacts1_mobile;
	}
	...
	public String getContacts2_mobile() {
		return contacts2_mobile;
	}
	public void setContacts2_mobile(String contacts2_mobile) {
		this.contacts2_mobile = contacts2_mobile;
	}
