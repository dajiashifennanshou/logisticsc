...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-02 23:43
 */

public class SendSmsApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SendSmsApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//第六步 hmac签名验证
		if(!ZGTUtils.checkHmac(responseDataMap, ZGTUtils.SENDSMSAPI_RESPONSE_HMAC_ORDER)) {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/45sendSmsApiResponse.jsp");
