...
public class RefundApiServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//第六步 hmac签名验证
		if(!ZGTUtils.checkHmac(responseDataMap, ZGTUtils.REFUNDAPI_RESPONSE_HMAC_ORDER)) {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/412refundApiResponse.jsp");
