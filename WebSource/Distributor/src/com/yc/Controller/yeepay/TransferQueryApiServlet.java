...
/**
 * @author: yingjie.wang    
 * @since : 2015-10-03 16:05
 */

public class TransferQueryApiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public TransferQueryApiServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//第六步 hmac签名验证
		if(!ZGTUtils.checkHmac(responseDataMap, ZGTUtils.TRANSFERQUERYAPI_RESPONSE_HMAC_ORDER)) {
		...
		RequestDispatcher view	= request.getRequestDispatcher("jsp/49transferQueryApiResponse.jsp");
