		 ...
		 $.ajax({
 			...
 			success:function(data){
 				if(data.result){
 					...
 					alert(data.msg);
 					window.location.href="<%=request.getContextPath()%>/deliverGoods/deliverGoods.shtml?chooseid='fahuo'";
 				}
 			},
 		});
	}
...
<body>
	<div class="top">
			<div class="top-content">
				<!-- <div class="logo f">
				 	<img src="/logisticsc/resources/platform/img/logo-5.png" />
				 </div>-->
				 <!-- 
				 <div class="dh f">
				 	<span>
				 ...
				 <div class="denglu">
				 	...
				 	<!--	<a href="user/jumpreGister.shtml">注册账号</a>-->
				 </div>
			</div>
		</div>
		<div class="content1" id="theForm">
			<!--<div class="bg">
				<img alt="" src="/logisticsc/resources/platform/img/3.png">
			</div> -->
			<div class="container1">
				<div style="text-align: center;margin-top: 15px;"><img src="/logisticsc/resources/platform/img/logo-5.png" alt=""></div>
