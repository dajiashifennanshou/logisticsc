...
<style>
    ...
    background-size:cover;
        ...
        .top-container .header > header{
            padding:40px; width:560px; margin:0 auto;
        }
...
<body>
	<div class="top-container">
        <div class="header">
            <header>
                <label class="l-logo">
                    <span class="a-fadeinT">后台管理系统</span>
                    <!-- <span class="a-fadeinR">系统平台</span> -->
                </label>
            </header>
        </div>
    ...
    $(function(){
        ...
        seajs.use(['bui/cookie', 'bui/tooltip' ,'bui/overlay'], function( cookie, Tooltip ){
            ...
            $("#loginBtn").click(function(){
                ...
                $.ajax({
                    url : "${configProps['project']}/tologin.shtml",
                    type : 'POST',
                    cache : false,
                    ...
                    success:function(data){
                        if (data.result) {
                            ...
                            // 登录成功
                            window.location = "${configProps['project']}/main.shtml";
