...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '{0}条未选择',                                                        // text when all options are visible / false for no info text
      infoTexted:'已选择 {0} 条',
      infoTextFiltered: '<span class="label label-warning">检索完成</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: '空集合',                                                        // when there are no options present in the list
  ...
  function refreshInfo(dualListbox) {
    ...
    if (all2 === 0) {
      ...
      content = formatString(dualListbox.settings.infoTexted, [visible2, all2]);
    } else {
