$(document).ready(function() {
	...
	$("#querenzhuce").click(function() {
		return companyName() && postCode() && companyAddress() && companyPhone() && legalPerson() && companyFax() && legalMobile() && companyTaxNo() && contacts() && financeEmail() && contactsMobile() && companyInfo() && qq() && logMsg() && businessLicenses() && companyPhotos() && legalPhotos() && cardphotos() && agree() && enterprise();
	});
...
function xiayibu(){
	var data = $("#enter_prise").serialize();
	$.ajax({
...
function enterprise(){
	var option = {
        url : '/logisticsc/user/doinsertEnterprise.shtml',
        type : 'post',
        dataType : 'json',
