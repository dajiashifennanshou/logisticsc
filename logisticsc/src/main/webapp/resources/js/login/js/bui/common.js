...
var ArrayUtil = {
  ...
  removeAt: function(array, index) {
    ...
    slice : function(arr, start, opt_end){
        ...
        // TODO : editor by wendell, 兼容ie7
        opt_end = opt_end || arr.length;
        return Array.prototype.slice.call(arr, start, opt_end);
    },
    /**
     * @private
...

{
  ...
  setSelectedByField: function(field, value) {
      // 修复 select 无法默认值 value = ''; 的情况
      // edited by wendellsheh@qq.com on 2015-05-20
    /*
    if (!value) {
      value = field;
    ...
    BUI.each(attributes, function(attr) {
      ...
      try {
        if (name === FIELD_CFG) {
          ...
          //var value = attr.nodeValue; editor by wendellsheh@qq.com 2015.5.18
