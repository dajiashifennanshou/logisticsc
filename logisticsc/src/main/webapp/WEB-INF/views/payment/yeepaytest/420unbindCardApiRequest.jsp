...
<body>
	...
	<table width="80%" border="0" align="center" cellpadding="9" cellspacing="0" style="border:solid 1px #107929">
		...
		<form method="post" action="${configProps['project']}/yeePay/unbindCard.pay" target="_blank" accept-charset="UTF-8">
			<tr >
			...
			<tr >
				...
				<td width="70%" align="left"> 
					<input size="70" type="text" name="bindid" value="" required>
					<span style="color:#FF0000;font-weight:100;">*</span>
				</td>
			</tr>

			<tr >
				<td width="30%" align="right">解绑说明[cause]:</td>
				<td width="70%" align="left"> 
