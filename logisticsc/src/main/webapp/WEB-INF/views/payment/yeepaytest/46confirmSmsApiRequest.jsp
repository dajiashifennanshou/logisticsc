...
<body>
	...
	<table width="80%" border="0" align="center" cellpadding="9" cellspacing="0" style="border:solid 1px #107929">
		...
		<form method="post" action="${configProps['project']}/yeePay/confirmSms.pay" target="_blank" accept-charset="UTF-8">
			<tr >
			...
			<tr >
				<td width="30%" align="right">短信验证码[smscode]:</td>
				<td width="70%" align="left"> 
					<input size="70" type="text" name="smscode" value="">
				</td>
			</tr>
