				...
				<div class="row-fluid">
					<div class="span24">
				        <form class="well form-inline">
				            ...
				            <input type="text" class="input-normal" id="condition" placeholder="运单号/发货人/收货人">
	...
	<script type="text/javascript">
		...
		function loadwayBillFreightList(){
			BUI.use([ 'bui/grid', 'bui/data', 'bui/toolbar' ], function(Grid, Data,
				...
				store = new Store({
					url : '<%=request.getContextPath()%>/tms/waybillfreight/getwaybillfreightlist.shtml',
					autoLoad : true,
					proxy:{
						method:'post',
					},
		...
		function showReceiveMoneyDialog(){
			...
			for(var i = 0; i < selection.length; i++){
				...
				money += new Number(selected.total);
