	...
	<div class="row-fluid">
		...
		<div class="hide" id="receiveMoneyDialog">
			<form class="form-horizontal" id="receiveMoneyOrderForm">
				...
				<input type="hidden" name="isAgencyFund" value="1">
	...
	<script type="text/javascript">
		...
		function loadReceiveMoneyOrdertList(){
			BUI.use([ 'bui/grid', 'bui/data', 'bui/toolbar' ], function(Grid, Data,
				...
				store = new Store({
					url : '<%=request.getContextPath()%>/tms/waybillfreight/getagencyfundreceivemoneyorderlist.shtml',
					autoLoad : true,
					//remoteSort : true,
					pageSize : 10
				});
		...
		function showReceiveMoneyDialog(){
			...
			if(selection[0].status == 1){
				BUI.Message.Alert('已完结的订单不能收款','warning');
				return;
			}
