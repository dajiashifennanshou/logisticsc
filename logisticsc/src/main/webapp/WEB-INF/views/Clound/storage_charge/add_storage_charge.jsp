...
<title>云仓管理系统-添加仓库收费标准</title>
	...
	<script type="text/javascript">
		$(function(){
			storageCharge_.getYcStorageBranch();
			var branchNo = $("select[name=branchNo]").val();
			storageCharge_.getStorageZone(branchNo);
			//下拉框初始化
		...
		<div class="widget-main">
			<div class="step-content pos-rel">
				<div class="step-pane active" data-step="1">
					<form class="form-horizontal" id="add_charge_form"  role="form">
						<!-- input标签 -->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="branchNo">网点编号</label>
							<div class="col-sm-9">
								<select group="val" name="branchNo" valited="required" class="select2-container select2-allowclear select2 tag-input-style" onchange="storageCharge_.getStorageZone(this.value);">
									<option value=""></option>
								</select>
							</div>
						</div>
			...
			<div class="wizard-actions">
				...
				<a onclick="storageCharge_.addSubmit('add_charge_form');" class="btn btn-success btn-next" data-last="Finish">
					提交
