...
<head>
	...
	<script type="text/javascript" src="/logisticsc/Clound/js/goods_statistics/goods_statistics.js"></script>
	<style type="text/css">
...
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">盘库存</h4>
	</div>
	<div class="widget-header" style="padding-top: 6px;">
		<form id="gs_from">
			...
			<div id="count">出库数量：<span>0</span></div>
			<div id="count">入库数量：<span>0</span></div>
		</form>
	</div>
