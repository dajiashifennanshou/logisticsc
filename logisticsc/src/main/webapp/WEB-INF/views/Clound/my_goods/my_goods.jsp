...
<head>
	...
	<script type="text/javascript" src="/logisticsc/Clound/js/my_goods/my_goods.js"></script>
	<script type="text/javascript">
		$(function(){
			goods_.newGird("#goods_tab", "#goods_pager");
		});
	</script>
</head>
<body>
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">我的货物信息</h4>
	</div>
