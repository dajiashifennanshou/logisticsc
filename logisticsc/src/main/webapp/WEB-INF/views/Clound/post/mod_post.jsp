...
<title>云仓管理系统-修改职位¯</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			post_.getModData(id,"mod_post_form");
			//下拉框初始化
...
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">修改职位信息</h4>
	</div>
	<div class="widget-body">
		<div class="widget-main">
			<div class="step-content pos-rel">
				<div class="step-pane active" data-step="1">
					<form class="form-horizontal" id="mod_post_form"  role="form">
			...
			<div class="wizard-actions">
				...
				<a onclick="post_.modSubmit('mod_post_form');" class="btn btn-success btn-next" data-last="Finish">
					提交
