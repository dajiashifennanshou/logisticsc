	...
	<div class="widget-body">
		<div class="widget-main">
			<div class="step-content pos-rel">
				<form class="form-horizontal" id="add_special_form"  role="form">
			...
			<div class="wizard-actions">
				...
				<a onclick="special_.addSubmit('add_special_form');" class="btn btn-success btn-next" data-last="Finish">
					下页
