...
<title>云仓管理系统-修改货物类型</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			goodsType_.getModData(id, "mod_employee_form");
			//下拉框初始化
...
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">修改货物类型</h4>
	</div>
	<div class="widget-body">
		<div class="widget-main">
				...
				<div class="step-pane active" data-step="1">
					<form class="form-horizontal" id="mod_employee_form"  role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" group="val" name="softName" valited="required" placeholder="类型名称" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
			...
			<div class="wizard-actions">
				...
				<a onclick="goodsType_.modSubmit('mod_employee_form');" class="btn btn-success btn-next" data-last="Finish">
					提交
