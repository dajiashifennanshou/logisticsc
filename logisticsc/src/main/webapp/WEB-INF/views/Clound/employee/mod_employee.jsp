...
<title>云仓管理系统-修改员工信息</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			employee_.getModData(id, "mod_employee_form");
			//下拉框初始化
...
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">修改员工信息</h4>
	</div>
	<div class="widget-body">
		<div class="widget-main">
			<div class="step-content pos-rel">
				<div class="step-pane active" data-step="1">
					<form class="form-horizontal" id="mod_employee_form"  role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select group="val" name="gender" class="select2-container select2-allowclear select2 tag-input-style">
									<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" group="val"  name="age" min="0"  placeholder="年龄" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" group="val" name="term" min="0" placeholder="工作年限" class="col-xs-10 col-sm-5" />
							</div>
						</div>
			...
			<div class="wizard-actions">
				...
				<a onclick="employee_.modSubmit('mod_employee_form');" class="btn btn-success btn-next" data-last="Finish">
					提交
