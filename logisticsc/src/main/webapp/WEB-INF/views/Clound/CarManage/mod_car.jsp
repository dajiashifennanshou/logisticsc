...
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">修改车辆信息</h4>
	</div>
	<div class="widget-body">
		<div class="widget-main">
			<div class="step-content pos-rel">
				<div class="step-pane active" data-step="1">
						<form class="form-horizontal" id="mod_car"  role="form">
						<input type="hidden" group="val" name="id">
						<div class="form-group"> 
							<label class="col-sm-3 control-label no-padding-right" for="carNo">车牌号</label>
							<div class="col-sm-9">
								<input type="text" group="val" disabled="disabled" name="carNo" valited="required,carNumber" placeholder="车牌号" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="carType">车型</label>
							<div class="col-sm-9">
								<select group="val" name="carType" disabled="disabled" valited="required" id="carType" class="select2-container select2-allowclear typeSel tag-input-style">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" group="val" disabled="disabled" name="weight" valited="required,number" placeholder="载重量" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="volume">荷载体积</label>
							<div class="col-sm-9">
								<input type="text" group="val" disabled="disabled" name="volume" valited="required,float" length=2 placeholder="荷载体积" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
			...
			<div class="wizard-actions">
				...
				<a onclick="car_.modSubmit('mod_car');" class="btn btn-success btn-next" data-last="Finish">
					提交
