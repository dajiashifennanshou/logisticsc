...
<head>
	...
	<script type="text/javascript">
		$(function(){
			storageBranch_.newGrid("#storage_branch_tab", "#storage_branch_pager");
		});
	</script>
</head>
<body>
<div class="widget-box">
	<div class="widget-header widget-header-blue widget-header-flat">
		<h4 class="widget-title lighter">云仓网点管理</h4>
	</div>
	<div class="widget-header" style="padding-top: 6px;">
		<form id="sb_form">
			...
			<button type="button" class="btn btn-purple btn-sm" onclick="storageBranch_.condSearch();">
				<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
				确定
			</button>
		</form>
	</div>
	<table id="storage_branch_tab"></table>
	<div id="storage_branch_pager"></div>
</div>
</body>
</html>
