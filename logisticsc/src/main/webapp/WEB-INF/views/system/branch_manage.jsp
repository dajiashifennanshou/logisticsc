...
<body>
	<div class="panel">
        <div class="panel-header">
           	<h2 style="color:green;">云仓网点管理</h2>
	...
	var number = 0;
		...
		function addFunction(){
			window.location.href="toAddStorageBranch.yc";
		}
		/* 修改 */
		function editFunction(id){
			window.location="toModStorageBranch.yc?id="+id;
		}
		/**
		删除*/
		...
		BUI.use(['bui/grid','bui/data','bui/toolbar','bui/format','bui/form','bui/overlay'],
			...
			columns = [
				...
				{title : '合作方式',elCls:'center',width:60,dataIndex:'joinType',renderer:function(val){
					return Constant.StorageBranchJoinType[val];
				}},
				{title : '仓库类型(M²)',elCls:'center',width:100,dataIndex:'branchType',renderer:function(val){
					return Constant.StorageBranchType[val];
				}},
				{title : '地址',elCls:'center',width:230,dataIndex :'province',renderer:function(val,obj){
					return obj.province+obj.city+obj.county;
				}},
				{title : '负责人',elCls:'center',width:130,dataIndex :'masterName'},
				{title : '联系电话',elCls:'center',dataIndex :'masterPhone'},
				{title : '创建时间',elCls:'center',width:170,dataIndex:'createTime' ,renderer:function(val){
