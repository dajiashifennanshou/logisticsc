...
<body>
	...
	<script type="text/javascript">
		...
		BUI.use(['bui/grid','bui/data','bui/toolbar','bui/format'],
			...
			Store = Data.Store,
			columns = [
				{title : '公司名称',elCls:'center',dataIndex:'companyName',renderer:function(value,obj){
			...
			store = new Store({
				url: '<%=request.getContextPath()%>/sys/tms/member/searchLogistics.shtml',
				autoLoad:true,
				proxy:{
					method:'post',
				},
