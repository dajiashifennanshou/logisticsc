	...
	<div class="demo-content">
	    <form id="J_Form" action="" class="form-horizontal" enctype="multipart/form-data">
	      <div class="control-group">
	        ...
	        <div class="controls">
	          <input name="newsTitle" type="text" class="input-large" placeholder="请输入新闻标题" value="${news.newsTitle}">
	          <input name="newsType" value="0" style="display: none">
  				...
  				success:function(data){
  					if (data.result == true) {
  						BUI.Message.Alert("操作成功！！！",function(){
  							window.location.href="${configProps['project']}/system/news/jumpNews.shtml";
  						},"success");
				}else{
