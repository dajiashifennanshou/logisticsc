...
<body>
	<div class="panel">
        ...
        <div class="panel-body">
	        <form id="search_form" class="well form-inline" enctype="multipart/form-data">
        		...
        		<input id="condition" name="condition" type="text" placeholder="资讯标题">
	...
	BUI.use(['bui/grid','bui/data','bui/toolbar','bui/format','bui/select'],
		...
		store = new Store({
			url: '<%=request.getContextPath()%>/system/news/getNews.shtml?newsType='+1,
			autoLoad:true,
			proxy:{
				method:'post',
			},
		...
		function addAd(){
			window.location.href="<%=request.getContextPath()%>/system/news/jumpAddNewsInformation.shtml";
		}
		function editAd(){
