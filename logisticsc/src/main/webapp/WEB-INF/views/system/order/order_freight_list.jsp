	...
	<div class="panel">
        ...
        <div class="panel-body">
        	<form id="search_form" class="well form-inline">
	          	...
	          	<input id="companyName" name="companyName" type="text" placeholder="输入物流公司名称">
	          	<input id="companyCode" name="companyCode" type="text" placeholder="输入组织代码">
	...
	<script type="text/javascript">
		...
		BUI.use(['bui/grid','bui/data','bui/toolbar','bui/format','bui/form','bui/overlay'],
			...
			columns = [
				...
				{title : '数量(单)',dataIndex :'num'},
				{title : '金额(元)',dataIndex :'total'},
				/* {title : '电话',dataIndex :'company_phone'}, */
			];
			store = new Store({
				url: '<%=request.getContextPath()%>/systemOrder/getOrderCompanyRanking.shtml',
				autoLoad:true,
				proxy:{
					method:'post',
				},
