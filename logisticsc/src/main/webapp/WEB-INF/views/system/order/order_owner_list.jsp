...
<div class="panel">
        ...
        <div class="panel-body">
        	<form id="search_form" class="well form-inline">
	          	<input id="loginName" name="loginName" type="text" placeholder="输入用户账号">
	...
	<script type="text/javascript">
		...
		BUI.use(['bui/grid','bui/data','bui/toolbar','bui/format','bui/form','bui/overlay'],
			...
			msg = BUI.Message,
			columns = [
				{title : '用户账号',dataIndex :'login_name'},
				{title : '发货数量(单)',dataIndex :'num'},
				{title : '公司',dataIndex :'company_name'},
				{title : '总金额(元)',dataIndex :'price'},
			];
			store = new Store({
				url: '<%=request.getContextPath()%>/systemOrder/getOrderUserRanking.shtml',
				autoLoad:true,
				proxy:{
					method:'post',
				},
