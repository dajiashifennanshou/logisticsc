...
<script type="text/javascript">
	function tiaohzuan() {
		window.location.href="<%=request.getContextPath()%>/applyCenter/toorderEnterpriseOwner.shtml";
	}
</script>
<body>
...
<div id="#container">
	<div class="container-self">
		...
		<div class="demo-content platformStyle" style="position:relative;">
			<img src="/logisticsc/resources/platform/img/enterprise-apply-flow.png" />
		</div>
		<button type="button" style="margin:0px auto 0px -100px;position: absolute;left: 50%;top: 300px;padding: 12px 52px;background:#0055bf;border: medium none;font-weight: bold;font-size: 16px;" class="btn btn-success" onclick="tiaohzuan()">申请企业货主</button>
	</div>
</div>
<div class="footer">
