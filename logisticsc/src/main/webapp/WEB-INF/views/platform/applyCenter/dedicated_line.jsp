...
<script src="${configProps['resources']}/platform/js/dedicatedLineOwner.js"></script>
</head>
<body>
				...
				<div class="denglu2" style="margin-top: 30px;margin-left: 20px;">
					...
					<div role="form" class="form-horizontal con1 con2" style="margin-top: 24px;">  
						...
						<label class="login-sjh" id="agreeMsg"></label>
						  	<input type="checkbox" id="agree" name="agree"/>  我已看过并同意<a href="../platform-apply.html" target="_blank">《专线申请协议》</a>
						</label>
					</div>
					<div class="form-horizontal con1 con2 con3">
						<div class="btn btn-info wc-btn col-lg-offset-3" id="shenqingqiye">申请专线</div>
					</div>
				</div>
			</form>	
			</div>	
