...
<link rel="stylesheet" href="${configProps['resources']}/platform/css/register/zxzc-zhuce.css" />
...
<script type="text/javascript" src="${configProps['resources']}/platform/js/dedicatedLineRegister.js" ></script>
</head>
<body>
	<div class="top">
		...
		<div class="content">
			<form id="register_dedicatedLine" action="" enctype="multipart/form-data" method="post">
				<div class="container">
					<div class="row">
							<p class="col-sm-12">专线注册</p>
							<a href="${configProps['project']}/user/jumpreGister.shtml?" class="grhz">
								个人货主注册
							</a>
							<a href="${configProps['project']}/user/jumpreEnterprise_register.shtml?" class="zxhz">
								企业货主注册
							</a>
							...
							<div class="denglu2-top">
								...
								<div role="form" class="form-horizontal con1 con2">  
									...
									<label class="login-sjh" id="agreeMsg"></label>
									  	<input type="checkbox" id="agree" name="agree"/>  我已看过并同意《专线服务条款》
									</label>
								</div>
								<div class="form-horizontal con1 con2 con3">
