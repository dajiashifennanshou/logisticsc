...
public class OutletsInfo implements Serializable{
    ...
    private List<PosBind> posBinds;

    public AdditionalServerConf additionalServerConf;

	public List<PosBind> getPosBinds() {
		return posBinds;
	}

	public void setPosBinds(List<PosBind> posBinds) {
		this.posBinds = posBinds;
	}
	...
	public AdditionalServerConf getAdditionalServerConf() {
		return additionalServerConf;
	}

	public void setAdditionalServerConf(AdditionalServerConf additionalServerConf) {
		this.additionalServerConf = additionalServerConf;
	}
