package com.brightsoft.servlet;
...
import com.brightsoft.utils.yeepay.AESUtil;
import com.brightsoft.utils.yeepay.Digest;
...
public class UpLoadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("getKeyForHmac=" + key);
		System.out.println("uploadurl=" + uploadurl);
		String customernumber   = formatStr(map.get("customernumber"));
