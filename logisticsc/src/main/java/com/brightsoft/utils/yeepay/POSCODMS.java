...
@XmlType(propOrder = {  "requestHead", "responseHead","posExtendAtt","posLoginRequestBody","posOrderRequestBody","posPayRequestBody","posPayResponseBody","posSignRequestBody","posSignResponseBody","posReimburseResponseBody","posCancelOrderResponseBody"}) 
public class POSCODMS {
	...
	private POSReimburseResponseBody posReimburseResponseBody;
	private POSCancelOrderResponseBody posCancelOrderResponseBody;

	

	public POSCancelOrderResponseBody getPosCancelOrderResponseBody() {
		return posCancelOrderResponseBody;
	}

	public void setPosCancelOrderResponseBody(
			POSCancelOrderResponseBody posCancelOrderResponseBody) {
		this.posCancelOrderResponseBody = posCancelOrderResponseBody;
	}

	public POSReimburseResponseBody getPosReimburseResponseBody() {
		return posReimburseResponseBody;
	}

	@XmlElement(name = "SessionBody")
	public void setPosReimburseResponseBody(
			POSReimburseResponseBody posReimburseResponseBody) {
		this.posReimburseResponseBody = posReimburseResponseBody;
	}
