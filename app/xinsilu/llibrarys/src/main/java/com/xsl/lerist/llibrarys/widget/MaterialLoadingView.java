...
public class MaterialLoadingView extends View {
    ...
    public MaterialLoadingView(Context context, AttributeSet attrs) {
        ...
        parseAttrs(context.obtainStyledAttributes(attrs, R.styleable.MaterialLoadingView));
    }
    ...
    private void parseAttrs(TypedArray a) {
        ...
        mStartColor = a.getColor(R.styleable.MaterialLoadingView_mp_startColor, mStartColor);
        mMidColor = a.getColor(R.styleable.MaterialLoadingView_mp_midColor, mMidColor);
        mEndColor = a.getColor(R.styleable.MaterialLoadingView_mp_endColor, mEndColor);
        mRadius = (int) a.getDimension(R.styleable.MaterialLoadingView_mp_radius, mRadius);
        mStrokeWidth = (int) a.getDimension(R.styleable.MaterialLoadingView_mp_strokeWidth, mStrokeWidth);
        mSpeed = a.getFloat(R.styleable.MaterialLoadingView_mp_speed, mSpeed);
        a.recycle();
    ...
    /**
     * Set single color for MaterialLoadingView if you want
     *
     * @param color
     */
    ...
    /**
     * Set the colors for MaterialLoadingView as your like
     *
     * @param colors
     */
