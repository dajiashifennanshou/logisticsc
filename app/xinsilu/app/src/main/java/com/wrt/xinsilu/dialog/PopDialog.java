...
public class PopDialog extends Dialog implements View.OnClickListener {
    ...
    private String tempPhotoPath = MyApplication.PATH_TEMP + "/temp.jpg";
    ...
    public void onClick(View v) {
        if (!EasyPermissions.hasPermissions(context, Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            new AlertDialog.Builder(context).setTitle("提示")
                    ...
                    .setPositiveButton("去授权", new OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                        ...
                        if (!StringUtils.isEmpty(photoPath)) {
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    final File file = FileUtils.createFile(MyApplication.PATH_TEMP, "Temp" + System.currentTimeMillis() + ".jpg");
