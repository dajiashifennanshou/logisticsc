 ...
 * 常用发货人
 */
public class CommonReceiverListFragment extends LRecyclerViewFragment implements Selectable, LRecyclerViewAdapter.OnLoadListener, LRecyclerViewAdapter.LOnItemClickListener {
    ...
    public RecyclerView.Adapter getRecyclerViewAdapter() {
        recyclerViewAdapter = new LRecyclerViewAdapter<SenderBean>(context) {
            ...
            public void onBindViewHolder(LRecyclerViewHolder viewHolder, int position, final SenderBean itemData) throws Exception {
                ...
                viewHolder.setText(R.id.i_common_list_sender_tv_hint_addr, "收货地址:  ");
...
//            startActivity(LoginActivity.class);
        ...
        mCurrentPage = page;
        commonContactClient.getReceiverList(userInfo.getUser().getId(), page, count, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                KLog.i(result);
                ResultInfo resultInfo = ResultInfo.toResultInfo(result);
