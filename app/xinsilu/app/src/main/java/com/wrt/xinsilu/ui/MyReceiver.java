...
//            showNotifycation(context,bundle.getString(JPushInterface.EXTRA_EXTRA));
    ...
    private void receivingNotification(Context context, Bundle bundle){
        ...
        String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);//这个是接收到推送过来的消息，一些字段
        Log.i(TAG, "extras : " + extras);
        BusProvider.getInstance().post(new BusProvider.BusEvent("update_order",message));
    }
    ...
    private void openNotification(Context context, Bundle bundle){
        ...
        try {
            ...
            Log.i("-------",myValue);
            ;
            context.startActivity(new Intent(context, MyOrderActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } catch (Exception e) {
