 ...
 * 新增收货人
 */
public class AddReceiverActivity extends SwipeBackActivity {
    ...
    private InputMethodManager imm;//输入判断
    /**
     * 城市选择器
     */
            ...
            case R.id.add_commit:
                ...
                if (TextUtils.isEmpty(addSenderName.getText().toString())) {
                    ...
                    client.addCommonContact(Common.ADD_COMMON_CONTACTS,
                            ...
                            "1", new Callback.CommonCallback<String>() {
                                @Override
