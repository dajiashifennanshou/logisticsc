package com.xsl.distributor.ws.ui.widget.cascade.activity;

import android.util.Log;


import com.xsl.distributor.ws.ui.widget.cascade.model.CityModel;
import com.xsl.distributor.ws.ui.widget.cascade.model.DistrictModel;
import com.xsl.distributor.ws.ui.widget.cascade.model.ProvinceModel;
import com.xsl.distributor.ws.ui.widget.cascade.service.XmlParserHandler;
...
public class BaseActivity {
	...
	/**
	 * 根据后台返回的字段获取省，或者市，或者的数据
	 */
	public void initCitydata(List<String>list){
		mProvinceDatas = new String[list.size()];
		for(int i = 0; i <list.size(); i++){
			mProvinceDatas[i] = list.get(i).toString();
		}
	}
