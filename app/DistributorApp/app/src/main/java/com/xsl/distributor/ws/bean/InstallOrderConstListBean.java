 ...
 * 安装配送费
 */
public class InstallOrderConstListBean implements Parcelable {
    ...
    public InstallOrderConstListBean() {
    }

    protected InstallOrderConstListBean(Parcel in) {
    ...
    public static final Creator<InstallOrderConstListBean> CREATOR = new Creator<InstallOrderConstListBean>() {
        @Override
        public InstallOrderConstListBean createFromParcel(Parcel in) {
            return new InstallOrderConstListBean(in);
        }

        @Override
        public InstallOrderConstListBean[] newArray(int size) {
            return new InstallOrderConstListBean[size];
        }
    };
