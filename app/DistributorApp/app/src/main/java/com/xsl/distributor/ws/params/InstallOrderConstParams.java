 ...
 * 获取安装费用
 */
public class InstallOrderConstParams extends BasicParams implements OnResponse{
    public InstallOrderConstParams(){
    }
    public InstallOrderConstParams(Context context, String url, String obj) {
    ...
    public <T> void onFinish() {
        BusProvider.getInstance().post(new InstallOrderConstParams());
    }
}
